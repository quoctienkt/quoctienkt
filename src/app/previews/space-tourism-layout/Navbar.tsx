    ...
    <>
      <nav className="basis-24 flex-none z-20 flex flex-row w-full justify-between pt-6 items-center max-lg:pt-0">
        ...
        <div className="px-12 cursor-pointer basis-[144px] flex-none [&>*]:w-12 max-sm:basis-24 max-sm:px-0 max-sm:flex max-sm:justify-center">
          <Image
            src="/quoctienkt/previews/space-tourism-layout/assets/shared/logo.svg"
        ...
        {!navbarOpen && (
          ...
          >
            <Image
              alt="Icon hamburger"
              src="/quoctienkt/previews/space-tourism-layout/assets/shared/icon-hamburger.svg"
              width={24}
              height={22}
        ...
        {navbarOpen && (
          <>
            ...
            >
              <Image
                alt="Icon close"
                src="/quoctienkt/previews/space-tourism-layout/assets/shared/icon-close.svg"
                width={24}
                height={22}
              />
            </div>
        ...
        <ol
          className={classes(
            ...
            toggle(
              navbarTransitioning && !navbarOpen,
              'max-sm:flex max-sm:translate-x-[100%]',
            ),
