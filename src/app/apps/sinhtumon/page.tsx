    ...
    <section className="relative w-screen h-screen bg-[#050711] overflow-hidden flex items-center justify-center p-2 sm:p-4">
      <div className="flex flex-col md:flex-row items-center justify-center gap-6 w-full max-w-5xl">
        ...
        <div
          ...
          style={{
            maxWidth: 'min(960px, calc(88vh * 680 / 760))',
            aspectRatio: '680/760',
          }}
        >
          <canvas
        ...
        <div className="w-full md:w-64 bg-[#0a0f1d]/90 backdrop-blur-md rounded-xl p-4 border border-slate-800 flex flex-col gap-4 text-white shadow-2xl">
          <div>
