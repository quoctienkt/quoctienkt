window.setupGameMapService = () => {
  window.GameMapServiceBase = class {
      ...
      for (
        ...
        if (
          ...
          let monsterPosition = [
            ...
            parseInt(
              this._gameStateService.savedData.monsters[i].x / this.mapConfig.CELL_SIZE
            ),
          ];
          ...
          if (
            (newMonsterPath[0][1] * this.mapConfig.CELL_SIZE + this.mapConfig.CELL_SIZE / 2 >
              this._gameStateService.savedData.monsters[i].x &&
              this._gameStateService.savedData.monsters[i].x >
                newMonsterPath[1][1] * this.mapConfig.CELL_SIZE + this.mapConfig.CELL_SIZE / 2) ||
            (newMonsterPath[0][1] * this.CELL_SIZE + this.mapConfig.CELL_SIZE / 2 <
              this._gameStateService.savedData.monsters[i].x &&
              this._gameStateService.savedData.monsters[i].x <
                newMonsterPath[1][1] * this.mapConfig.CELL_SIZE + this.mapConfig.CELL_SIZE / 2) ||
