      ...
      if (
        ...
        newMonsterPath.forEach((i) => {
          this.path.lineTo(
            ...
            i[0] * this._gameMapService.CELL_HEIGHT + this._gameMapService.GAME_BOARD_PADDING_TOP
          );
        });
        ...
        [this._gameMapService.START_POSITION, this._gameMapService.END_POSITION].forEach(
          (i) => {
            this.path.lineTo(
              this._gameMapService.CELL_SIZE * i[1] + this._gameMapService.CELL_SIZE / 2,
              i[0] * this._gameMapService.CELL_SIZE + this._gameMapService.GAME_BOARD_PADDING_TOP
            );
          }
        );
