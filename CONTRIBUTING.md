...
2. Ensure you have Node.js 25+ installed.
3. Run `npm install` to install dependencies.
4. Run `npm run dev` to start the development server.
5. If you've added code that should be tested, add tests.
6. Ensure the test suite passes.
7. Format the code with `npm run format`.
8. Check linting with `npm run lint`.

### Pull Requests

- Follow the formatting rules in `.prettierrc`.
- Make sure to update documentation if you are changing functionality.
- We use standard PR review process.
